                   ...
                   // fRootRef = FirebaseDatabase.getInstance().getReference(String.format("%d",i));
                    ...
                    if(i<numOfSub) {
                       ...
                       // fRootRef.setValue(eid);
                        ...
                        if(flag.equals("subject")) {
                            Toast.makeText(Subjects.this,"Subjects are inserted into database",Toast.LENGTH_SHORT).show();
                            Intent i= new Intent(Subjects.this,ShowSubjects.class);
                            startActivity(i);
                        }
                        else{

                            Toast.makeText(Subjects.this,"Students are inserted into database",Toast.LENGTH_SHORT).show();
                            Intent i= new Intent(Subjects.this,ShowStudent.class);
                            startActivity(i);
                        }
